...
map.getView().fit([12764070.428871, 794428.290010, 13856160.807918, 1367082.954538], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Integrated Land Resources Map</h2>';
        return titleElement;
    })(),
